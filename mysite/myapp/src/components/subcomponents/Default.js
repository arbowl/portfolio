    ...
    render() {
        return (
            <p>
                ...
                <p><b>Resume: </b> This is my resume, hosted online for your convenience. This site is a personal project, and in a way, is part of my resume.</p>
                <p><b>Portfolio:</b> School/career/personal projects showing the development of my technical skills.</p>
                <p><b>Photos:</b> I don't use social media much, so this is a place for me to show off some of my photos.</p>
                <p><b>Calendar:</b> An online planner for myself to keep track of what I'm up to and what's coming up.</p>
